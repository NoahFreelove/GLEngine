...
public class Image {
    ...
    public Image(String imagePath) {
        ...
        try (MemoryStack stack = stackPush()) {
            ...
            /*System.out.println("GLEngine.IO.Image width: " + w.get(0));
            System.out.println("GLEngine.IO.Image height: " + h.get(0));
            System.out.println("GLEngine.IO.Image components: " + comp.get(0));
            System.out.println("GLEngine.IO.Image HDR: " + stbi_is_hdr_from_memory(imageBuffer));*/
    ...
    public static void main(String[] args) {
        String imagePath;
        if (args.length == 0) {
            System.out.println("Use 'ant demo -Dclass=org.lwjgl.demo.stb.GLEngine.IO.Image -Dargs=<path>' to load a different image.\n");
    ...
    private void init() {
        ...
        this.window = glfwCreateWindow(ww, wh, "STB GLEngine.IO.Image Demo", NULL, NULL);
        if (window == NULL) {
